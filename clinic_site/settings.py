...
ASGI_APPLICATION = "clinic_site.asgi.application"
...
# Railway terminates TLS at its edge; keeping Django's redirect off lets the
# internal HTTP health check reach /health/ without a redirect loop.
